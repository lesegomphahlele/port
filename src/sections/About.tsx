...
// NOTE: have a capital letter for each icon so I can use as components
...
export const AboutSection = () => {
  {/* constraint for the elements I can drag */ }
  ...
  return (
    <div className="py-20 lg:py-28">
      <div className="container">
        ...
        <div className="mt-20 flex flex-col gap-8"> {/* contains all the cards */}
          
          <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3"> {/* top half of bento grid */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:grid-cols-3"> {/* bottom half of bento grid */}
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
                {/* duplicated the div to animate it */}
